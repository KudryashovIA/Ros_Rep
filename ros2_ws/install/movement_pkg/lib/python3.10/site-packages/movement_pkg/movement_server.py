...
# import the MyCustomServiceMessage module from custom_interfaces interface
...
class Service(Node):
    ...
    def __init__(self):
        ...
        self.srv = self.create_service(MyCustomServiceMessage, 'movement', self.CustomService_callback)
