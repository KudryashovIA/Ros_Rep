...
class MoveRobot(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('forwards_speed', 0.1)
    ...
    def getting_params(self):
        ...
        self.forwards_speed = self.get_parameter(
            'forwards_speed').get_parameter_value().double_value

        self.get_logger().info("############### turning_speed...."+str(self.turning_speed))
        self.get_logger().info("############### forwards_speed...."+str(self.forwards_speed))
    ...
    def timer_callback(self):
        ...
        if self.mode == "turning":
            self.go_forwards()
            self.mode = "go_forwards"
        if self.mode == "go_forwards":
            self.turn()
            self.mode = "turning"
        else:
            pass
    ...
    def go_forwards(self):
        self.cmd.linear.x = self.forwards_speed
