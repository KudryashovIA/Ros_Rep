...
# https://github.com/ros2/launch/blob/ec481fb0a5d9882fa7ca1bc073d8c4f91278bd38/launch/launch/actions/group_action.py
...
def generate_launch_description():
    ...
    forwards_speed_arg = DeclareLaunchArgument(
        "forwards_speed", default_value="0.1"
    )
        ...
        actions=[
            ...
            IncludeLaunchDescription(
                ...
                launch_arguments={'turning_speed': turning_speed_f,
                                  'forwards_speed': forwards_speed_f}.items()
            ),
        ],
    )
